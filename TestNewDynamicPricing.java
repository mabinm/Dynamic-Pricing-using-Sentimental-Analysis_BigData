...
public class TestNewDynamicPricing {
	...
	private static int[] vt = {1744,2777,956,5189,1322,160,1450,2988,2796,3044,27};
	...
	TestNewDynamicPricing NDP = new TestNewDynamicPricing();
	for(int i=0;i<10;i++)
		dynamicValuationResult[i] = DP.DynamicValuationCalculator(time[i], st[i], saverage[i]);
	
	for(int i=0;i<10;i++)
		dynamicArrivalRateResult[i] = DP.DynamicArrivalRateCalculator(time[i], vt[i], vaverage[i]);
